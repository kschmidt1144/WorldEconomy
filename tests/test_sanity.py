...
def test_ch10_world_forest_ownership(con):
...
def test_ch10_us_land_stack(con):
...
def test_ch10_farmland_value_per_acre(con):
...
def test_ch10_county_land_values(con):
...
def test_ch10_land_values_through_time(con):
...
def test_ch10_county_panel_five_vintages(con):
...
def test_ch10_slider_frames_exist(con):
...
def test_ch10_land_report_100(con):
...
def test_ch6_dashboard_complete(con):
    from econlab.analysis.ch11_synthesis import state_of_the_world
...
def test_ch6_crisis_decades(con):
    from econlab.analysis.ch11_synthesis import crisis_share_by_decade
