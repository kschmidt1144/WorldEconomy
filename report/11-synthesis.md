# Chapter 11 — Synthesis: how it got this way

*World Economy Lab. Generated 2026-07-19; module `econlab/analysis/ch11_synthesis.py`.
The capstone: every claim below points at a computation in Chapters 0–10,
and the chapter closes with the state of the world computed fresh from the
warehouse each build.*

![Vital signs](figures/11_vital_signs.png)
