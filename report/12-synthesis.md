# Chapter 12 — Synthesis: how it got this way
...
(Ch. 4); the gold standard holds r−g near zero (Ch. 2); the West's share of
world output peaks at 59.2% in 1913 (Ch. 1) and the *global* top-10% income
share peaks near 60% (Ch. 6) — global inequality's all-time maximum was the
...
(Ch. 2) and top-1% shares compressed to ~10% (Ch. 6). Fast growth, stable
...
returns (Ch. 3). The US top-1% share starts its round trip back to 20%
(Ch. 6); labor's share begins its seven-point slide. Meanwhile poor
...
time in two centuries (Ch. 6). China goes from #1 supplier of 8 countries to
**96** (Ch. 4). The same era's finance: the 2000s put **72% of economies
...
And under that sky, the *ownership* of the system concentrated. Banks
consolidated (**30,000 → ~4,000**, Ch. 9) while a new form — the index
manager — rose to hold more assets than any bank ever did (**BlackRock
$11.5T**, Ch. 9) and to cast the swing votes in corporate America (Ch. 10).
Meanwhile the household's basket diverged from its paycheck: real wages rose
modestly (**median +10%, top decile +25%**, 2000–24) while the essentials a
family cannot skip outran every wage quartile — **childcare +29%, college
+46%, hospital care +89%** (Ch. 8). The macro story got better; the
micro story, for most, got tighter.

## The spine: concentration
...
conspiracy; an **arithmetic**. From five independent directions, a few hold a lot:

- **Assets.** The US top 1% own **31.6%** of household wealth; the bottom half,
  **2.5%** (Ch. 6). The line drawn in 1929, erased by 1975, has been redrawn.
- **The ground.** Land concentrates too — the federal government alone holds
  ~**15× the hundred largest private owners combined**, and the value sits where
  the people are: cities generate ~90% of GDP on **3%** of the land (Ch. 7).
- **Institutions.** Three index managers — BlackRock, Vanguard, State Street —
  vote **~18–20% of every US mega-cap** and, between them, most of the S&P 500
  (Ch. 9–10). Ownership dispersed into index funds; *voting power* fused.
- **Chokepoints.** Below the asset layer sit physical bottlenecks — one Dutch
  firm (ASML) for the machines that print advanced chips, a handful of seed and
  ratings and clearing houses — where a single node gates a whole system (Ch. 10).
- **The decision rooms.** And the most powerful recurring meeting on Earth is not
  a billionaire summit but the **FOMC**: twelve people, eight closed-door meetings
  a year, whose decisions move the S&P **1.3×**, the 2-year yield **1.5×**, and
  volatility **1.4×** a normal day (Ch. 10). Davos moves markets *less* than an
  average Tuesday.

And it **persists**. Chapter 11 measured the same families and crowns across
centuries: the Rothschild fortune peaked near **0.27% of world GDP** (1882);
Musk today commands roughly **2.4× that** share. The names change; the shape
does not. If the report has one finding larger than any single number, it is
...
2. **Integration reverses.** 1913 → 1938 proved it; 2008's plateau is the
   live experiment (Ch. 4).
3. **Finance's stability is a policy regime, not a natural state** — zero
   crises under repression, 72%-breadth under liberalization (Ch. 3, 9).
...
5. **Distribution is chosen.** Same century, same technology: America's U,
   Europe's L (Ch. 6). And it compounds into *control* — the concentration
   spine above runs from assets to land to institutions to the decision rooms.
6. **The household and the index diverged.** Since 2000, real wages rose
   modestly (median +10%) while the essentials a family cannot skip — care,
   housing, college, hospitals — outran every wage quartile (Ch. 8). Aggregate
   growth and the median budget stopped telling the same story.
7. **The most powerful levers are fewer, and more public, than the myth.** Not
