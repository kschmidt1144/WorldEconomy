...
Chapters 0–11. The report can be read six ways, and this chapter reads them in
...
DuckDB warehouse of **~37 sources, ~15 million observations, year 1 CE → 2101** —
and **153 tests re-derive the load-bearing findings on every build, so the tests
...
If concentration is the spine, Chapter 11 is the vertebra that tests it — and the news
...
10. **Concentration is bounded and impermanent.** Great fortunes cluster near 1–3% of
    ...
    wealth-adjacent institutions, not wealth (Ch. 11).
11. **The 2026 configuration** — record-valuation markets, war-level debt, above-target
