# Chapter 6 — Synthesis: how it got this way

*World Economy Lab. Generated 2026-07-17; module `econlab/analysis/ch06_synthesis.py`.
Every claim below points at a computation in Chapters 0–5.*

![Vital signs](figures/06_vital_signs.png)

## The arc, 1870 → 2026

**1870–1913 — The first globalization.** Openness climbs to 45% of GDP
(Ch. 5); the gold standard holds r−g near zero (Ch. 2); the West's share of
world output peaks at 59.2% in 1913 (Ch. 1) and the *global* top-10% income
share peaks near 60% (Ch. 4) — global inequality's all-time maximum was the
colonial world, not ours. Banking crises hit ~half of economies each decade
(Ch. 6 panel): integrated, gold-constrained finance was crisis-prone.
...
(Ch. 2) and top-1% shares compressed to ~10% (Ch. 4). Fast growth, stable
...
returns (Ch. 6). The US top-1% share starts its round trip back to 20%
(Ch. 4); labor's share begins its seven-point slide. Meanwhile poor
...
time in two centuries (Ch. 4). China goes from #1 supplier of 8 countries to
**96** (Ch. 5). The same era's finance: the 2000s put **72% of economies
