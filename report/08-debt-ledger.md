...
*World Economy Lab. Generated 2026-07-17; module `econlab/analysis/ch08_debt.py`,
findings pinned by tests. Companion to Chapter 7: there the asset side of
...
![Who owns the federal debt](figures/08_who_owns_federal_debt.png)
...
![Debt service](figures/08_debt_service.png)
...
![Interest by income](figures/08_interest_by_income.png)
