# Chapter 12 — Dynasties: Fortunes and Crowns Across Centuries

*World Economy Lab. Generated 2026-07-19; module `econlab/analysis/ch11_dynasties.py`,
every finding pinned by tests. One question, asked seven ways: **can wealth
and power persist across generations — and what kills them?***

**The parts:** I — the Rothschilds (the best-documented fortune ever) ·
II — the Fuggers (the steepest) · II·b — the Medici (the smallest fortune,
the largest afterlife) · III — ten dynasties, five centuries ·
IV — deep time: what survived the fall of Rome · V — walking the Western
millennium · VI — the Eastern mirror, Byzantium → Ottomans ·
VII — the crowns of Europe, 476 → today.

## Part I — The Rothschilds: the ledger, not the myth

*Sources: the family's own partnership accounts (Ferguson's archival series,
transcribed digit-for-digit into the warehouse), the Bank of England
millennium dataset as denominator, and our Forbes table for the ending. The
Rothschilds are both the best-documented fortune in history and the most
mythologized; this part is the ledger, not the myth.*

### F1 — How it was amassed

![Rothschild arc](figures/12_rothschild_arc.png)
...
![Then vs now](figures/12_then_vs_now.png)
...
![Ten dynasties](figures/12_ten_dynasties.png)
...
![Deep time](figures/12_deep_time.png)
...
![Millennium walk](figures/12_millennium_walk.png)
...
- **1900s** — the two red bands: the wars that broke every *fortune* in
  Chapter 12 (Vienna 1938, Paris 1940, Mitsui 1946) barely nick the
...
![Byzantine walk](figures/12_byzantine_walk.png)
...
![Royal lines](figures/12_royal_lines.png)
...
*Next: Chapter 13 — Synthesis: how it all got this way — and the state of the world, right now.*
